...
function render_footer (model, signal) {
  ...
  var completedCount = (model.todos && model.todos.length > 0) ?
    (model.todos.length - count) : 0;
  var display_clear =  (completedCount > 0) ? "block;" : "none;";
